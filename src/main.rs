...
unsafe impl GlobalAlloc for ReportingAllocator {
    unsafe fn alloc(&self, layout: Layout) -> *mut u8 {
        unsafe {
            ...
            let bytes_requisted = layout.size();

            eprintln!("{}\t{}", bytes_requisted, time_taken.as_nanos());
            ptr
        }
    }
...
impl Particle {
    fn new(world: &World) -> Particle {
        ...
        let x_accleration = 0.0;
        let y_accleration = rng.gen_range(0.0..0.15);
        ...
        Particle {
            ...
            acceleration: [x_accleration, y_accleration].into(),
            color: [1.0, 1.0, 1.0, 0.99].into(),
        }
    }
